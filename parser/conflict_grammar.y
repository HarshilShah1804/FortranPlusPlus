...
free_form: declarations executables
      ;
...
program_body: declarations executables contains_block
            ;

module_body: declarations executables contains_block
           ;
...
type_def: TYPE DECL_SEP identifier type_def_body END_TYPE
        | TYPE DECL_SEP identifier type_def_body END_TYPE identifier
        ;
...
pp_directive: PP_DEFINE identifier
...
exec_pp_directive: PP_DEFINE identifier
                 | PP_DEFINE identifier INT_CONST
                 | PP_UNDEF identifier
                 ;
